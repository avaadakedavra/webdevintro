...
header("Location:http://localhost/12thMarksheet/12mks.php");
...
<html>
<head>
<title>12th form 2</title>

<meta charset="UTF-8">
<meta name="description" content="12 Form2">
...
.div1{
background:linear-gradient(to right,#bab47c,#bab260,#dbcd36);
}

.div2{
background:linear-gradient(to right,#42f4cb,#951ea0,#7a10a0);
}
...
<center>
<form class="div1" name="form6"  action="12mks.php" method="POST"   >
